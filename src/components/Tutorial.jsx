            ...
            <div className="container">
                ...
                <div className="tutorial-content">
                    ...
                    <div className="step-card">
                        ...
                        <p><a href="https://www.issnetonline.com.br/goiania/Online/Login/Login.aspx" target="_blank" rel="noopener noreferrer" className="whatsapp-link:hover">https://www.issnetonline.com.br/goiania/Online/Login/Login.aspx</a></p>
                    </div>
                </div>
            </div>
        </section>
